#####################################################################################################
# 01/07/2026 - Update the prompt to show the mark@hostname on the leftside instead of the rightside.
# 01/08/2026 - Added more comments 
#####################################################################################################

# Generated by Powerlevel10k configuration wizard on 2025-09-14 at 18:27 EDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49619.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, round separators, sharp heads, round tails, 2 lines, solid, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    full_dir                     # current directory
    vcs                     # git status
    context                 #MANADD - user@hostname on the left side
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    #context                 # user@hostname.      #MANADD - Hide on the right and moved to left side
    ...
    time                    # current time. #MANADD - I changed this to 12 hour format
    # =========================[ Line #2 ]=========================
    newline
  ...
  # --- custom segment: show absolute path (no tilde) ---  #MANADD
  prompt_full_dir() {
  # Use PWD explicitly so p10k shows the absolute path (no ~ substitution)
    p10k segment -t "${PWD}"
  }
  # --- style for custom full_dir segment ---
  typeset -g POWERLEVEL9K_FULL_DIR_FOREGROUND=7   # white text
  typeset -g POWERLEVEL9K_FULL_DIR_BACKGROUND=4   # blue background
  # --- icon for full_dir segment ---
  # Common folder icon (Nerd Font required)
  typeset -g POWERLEVEL9K_FULL_DIR_VISUAL_IDENTIFIER_EXPANSION=''

  # Optional: use a home icon when you're in /Users/mark
  # (requires Nerd Font with  glyph)
  # if [[ $PWD == $HOME* ]]; then
  #   typeset -g POWERLEVEL9K_FULL_DIR_VISUAL_IDENTIFIER_EXPANSION=''
  # fi
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR='─' #MANADD - This impacts the dashes on the line above the prompt 
  ...
  typeset -g POWERLEVEL9K_DIR_PATH_ABSOLUTE=1
  typeset -g POWERLEVEL9K_DIR_PATH_STYLE='absolute'
  ...
  typeset -g POWERLEVEL9K_DIR_HYPERLINK=0
  typeset -g POWERLEVEL9K_DIR_PATH_HOMEDIR_ABSOLUTE=1 
  ...
  #############################################################################################
  # MANADD - Override default context colors and template for the prompt
  # Run the followig command to get the list of available color codes:
  #   for i in {0..255}; do print -P "%F{$i}$i %f"; done  
  #   for i in {0..255}; do print -Pn "%K{$i}  %k%F{$i}${(l:3::0:)i}%f " ${${(M)$((i%6)):#3}:+$'\n'}; done
  #############################################################################################
  typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_FOREGROUND=0
  typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_BACKGROUND=220
  typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_TEMPLATE='%m'
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_FOREGROUND=0
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_BACKGROUND=220
  # MANADD - End Override
  ...
  #typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION=  #MANADD - Override default to always show context
